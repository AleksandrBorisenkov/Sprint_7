...
class TestCreateCourier:
    ...
    @allure.title('Создание  курьера с разными данным и сопоставление с результатом из документации.')
    ...
    @allure.title('Нельзя создать 2х одинаковых курьеров. Данные существущего в системе курьера. Ожидаем ошибку 409')
    ...
    @allure.title('Создаем без обязательного поля Login. Ожидаем ошибку 400.')
    ...
    @allure.title('Создаем без обязательного поля Password. Ожидаем ошибку 400.')
    ...
    @allure.title('Создаем без firstName. Ожидаем успех 201.')
    ...
    @allure.title('Передали в поле Login существующий в системе. Ожидаем ошибку 409.')
