...
class TestCheckLoginCourier:
    ...
    @allure.title('Проверка, что курьер смог залогинеться.')
    ...
    @allure.title('Логин не зарегистрирован в системе. Ожидаем ошибку 404')
    ...
    @allure.title('Логин не зарегистрирован. Ожидаем ошибку 400')
